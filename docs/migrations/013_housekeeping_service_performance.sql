-- FastCheckIn Housekeeping Service Performance — Stage A (migration 013)
-- Apply after 012_newsletter_subscribers_optional_columns.sql.
-- Numbered 013 to avoid collision with existing 004_* migrations.
