-- FastCheckIn Housekeeping Service Performance — Stage B (migration 014)
-- Apply after 013_housekeeping_service_performance.sql.
-- Adds recoverable structured checklist state to the Stage A session table (013).
