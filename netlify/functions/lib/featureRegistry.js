/**
 * Runtime Feature Registry (Netlify mirror — keep in sync with src/config/featureRegistry.ts)
 */
...
export const FEATURE_REGISTRY = {
  ...
  csv_guest_export: {
    ...
    dependencies: [],
    upsellMessage: '',
    businessBenefit: 'Own your data',
    customerBenefit: 'Portable records',
    version: '1.0.0',
    introduced: '2025-01-01',
    deprecated: null,
  },
  ...
  visitor_countries: {
    ...
    upsellMessage: 'Country origins help you focus marketing where guests actually come from.',
  ...
  visitor_cities: {
    ...
    upsellMessage: 'City-level insight supports local demand decisions and multi-site readiness.',
