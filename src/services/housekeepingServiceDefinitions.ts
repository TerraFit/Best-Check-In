import type {
  HousekeepingChecklistSection,
  HousekeepingTaskType,
} from '../types/housekeeping';

/**
 * Structured, phone-friendly checklists for the first service-performance release.
 * Keep item ids stable: they are persisted inside service-session checklist_state.
 */
const REFRESH: HousekeepingChecklistSection[] = [
  {
    ...
    items: [
      ...
      { id: 'refresh-ac', label: 'Check air conditioning/heating' , issueReportable: true },
      { id: 'refresh-lights', label: 'Check lights and obvious defects', issueReportable: true },
    ],
  },
  {
    id: 'refresh-bathroom',
    ...
    items: [
      ...
      { id: 'refresh-water', label: 'Check hot/cold water and drainage', issueReportable: true },
    ],
  },
  {
    id: 'refresh-final',
    ...
    items: [
      ...
      { id: 'refresh-tv', label: 'Check TV/remote presentation', issueReportable: true },
      { id: 'refresh-doors', label: 'Check doors, locks and visible hardware', issueReportable: true },
...
const FULL_SERVICE: HousekeepingChecklistSection[] = [
  {
    ...
    items: [
      ...
      { id: 'full-mattress', label: 'Inspect mattress and mattress protector', issueReportable: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'full-water', label: 'Check water pressure, temperature and drainage', issueReportable: true },
      { id: 'full-ventilation', label: 'Check bathroom ventilation/extraction', issueReportable: true },
    ],
  },
  {
    id: 'full-living',
    ...
    items: [
      ...
      { id: 'full-lighting', label: 'Check all lighting', issueReportable: true },
      { id: 'full-electronics', label: 'Check TV, remote and electronics', issueReportable: true },
      { id: 'full-fridge', label: 'Clean and restock minibar/fridge' },
      { id: 'full-coffee', label: 'Clean and restock coffee/tea station' },
      { id: 'full-doors', label: 'Check doors, locks and handles', issueReportable: true },
      { id: 'full-ac', label: 'Check air conditioning/heating', issueReportable: true },
      { id: 'full-safety', label: 'Check obvious safety hazards', issueReportable: true },
    ],
  },
  {
    id: 'full-final',
    ...
    items: [
      ...
      { id: 'full-guest-property', label: 'Check for guest property or lost items' },
