...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-4 bg-orange-500 text-white rounded-lg font-bold text-lg hover:bg-orange-600 transition-colors shadow-lg"
              >
                Start Your 14-Day Free Trial
              </button>
              <button
                onClick={() => navigate('/business/login')}
                className="px-8 py-4 bg-white text-orange-500 border-2 border-orange-500 rounded-lg font-bold text-lg hover:bg-orange-50 transition-colors"
              >
                Business Login
              </button>
            </div>
      ...
      {/* Trust Badge - Authentic */}
      <div className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm uppercase tracking-wider text-gray-500 mb-4">Trusted By</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            <span className="text-gray-400 text-lg font-medium">Luxury Hotels SA</span>
            <span className="text-gray-400 text-lg font-medium">Cape Town Tourism</span>
            <span className="text-gray-400 text-lg font-medium">SA Guest House Assoc.</span>
          </div>
          <p className="text-sm text-gray-500 mt-6">Join the growing community of South African hospitality businesses</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-8 rounded-xl shadow-lg text-white">
            ...
            <button
              onClick={() => navigate('/register')}
              className="w-full py-3 bg-white text-orange-500 rounded-lg font-bold hover:bg-gray-100 transition-colors"
            >
              Start Free Trial
            </button>
          </div>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            onClick={() => navigate('/register')}
            className="px-8 py-4 bg-white text-orange-500 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg"
          >
            Get Started Today
          </button>
