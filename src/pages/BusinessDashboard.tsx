...
export default function BusinessDashboard() {
  ...
  const { currentPage, setCurrentPage, pageSize, setPageSize, totalBookingsCount: localTotalBookingsCount, totalPages: localTotalPages, activeTab, setActiveTab, showQRModal, setShowQRModal, showImportModal, setShowImportModal, editingProfile, setEditingProfile, savingProfile, setSavingProfile, guestChartType, setGuestChartType, referralChartType, setReferralChartType, trialDaysLeft, subscriptionStatus, profileForm, setProfileForm, newsletterEnabled, setNewsletterEnabled, newsletterTitle, setNewsletterTitle, newsletterPrize, setNewsletterPrize, newsletterCta, setNewsletterCta, newsletterTerms, setNewsletterTerms, newsletterDrawDate, setNewsletterDrawDate, newsletterShareText, setNewsletterShareText, savingNewsletter, setSavingNewsletter, subscribers, setSubscribers, showSubscribers, setShowSubscribers, loadingSubscribers, setLoadingSubscribers, showAppealModal, setShowAppealModal, rejectedRequest, setRejectedRequest } = useDashboardState();
  ...
  const nextRoomTier: Record<string, string> = { starter: 'growth', growth: 'pro', pro: 'business', business: 'enterprise', enterprise: 'enterprise' };
  ...
  <UpgradePromptModal isOpen={roomUpgradeOpen} onClose={()=>setRoomUpgradeOpen(false)} currentTier={subscriptionTier} featureName="Additional rooms" targetTier={nextRoomTier[subscriptionTier] || 'growth'} onUpgrade={()=>navigate('/billing')} onCompare={()=>navigate('/billing')} />
  </div>;
}