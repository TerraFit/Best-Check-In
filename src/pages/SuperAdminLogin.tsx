  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">Super Admin Portal</h2>
        <p className="mt-2 text-center text-sm text-gray-600">Secure access for platform administrators</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1">
                <input id="email" name="email" type="email" autoComplete="email" required value={formData.email}
                  ...
                  placeholder="superadmin@fastcheckin.co.za" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-700 focus:outline-none" tabIndex={-1}>
                  {showPassword ? (
          ...
          <div className="mt-6 text-center space-x-4">
            <Link to="/business/login" className="text-sm text-orange-600 hover:text-orange-500">Business Login</Link>
